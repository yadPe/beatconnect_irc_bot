...
module Task = {
  ...
  module Setters = {
    let setName = (name, t) => {...t, name: name}
    let setDescription = (description, t) => {...t, description: description}
    let setStatus = (status, t) => {...t, status: status}
    let setSection = (section, t) => {...t, section: section}
  }
}
